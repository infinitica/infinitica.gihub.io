...
* Attempt to decompile or reverse engineer any software contained by theinfinitica;
...
You agree that all agreements and transactions between you and us will be done electronically. You agree to receive all notices and terms regarding the Services either by (a) e-mail to you, by (b) posting them on the web page of the applicable service or by (c) direct insertion in the theinfinitica for India software. To receive electronic notices, you must have access to the Internet and a current version of an Internet browser. You will need to provide your own printer if you want to print any of our terms.
